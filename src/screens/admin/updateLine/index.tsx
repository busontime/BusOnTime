...
export const UpdateLine = () => {
  ...
  const update = async () => {
    if (validateForm()) {
      try {
        ...
        const info = await lineService.updateLineById(idLine, data);
        navigation.goBack();
  ...
  const getData = async () => {
    try {
      const response = await lineService.getLineById(idLine);
                ...
                <XStack space='$1'>
                  <XStack>
                    <FormInput
                      ...
                      type={'numeric'}
                      placeholder='Latitud'
                      value={formValues.origin?.latitude.toString() || ''}
                      onChangeText={(text) => {
                        setFormValues({
                          ...formValues,
                          origin: {
                  ...
                  <XStack>
                    <FormInput
                      ...
                      value={formValues.origin?.longitude.toString() || ''}
                      onChangeText={(text) => {
                        setFormValues({
                          ...formValues,
                          origin: {
                ...
                <XStack space='$1'>
                  <XStack>
                    <FormInput
                      ...
                      type={'numeric'}
                      placeholder='Latitud'
                      value={formValues.destination?.latitude.toString() || ''}
                      onChangeText={(text) => {
                        setFormValues({
                          ...formValues,
                          destination: {
                  ...
                  <XStack>
                    <FormInput
                      ...
                      type={'numeric'}
                      placeholder='Longitud'
                      value={formValues.destination?.longitude.toString() || ''}
                      onChangeText={(text) => {
                        setFormValues({
                          ...formValues,
                          destination: {
